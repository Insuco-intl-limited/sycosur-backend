...
class ODKProjects(TimeStampedModel):
    ...
    last_sync = models.DateTimeField(auto_now=True, verbose_name="Last synchronization", null=True)
    created_by = models.ForeignKey(User, null=True, on_delete=models.SET_NULL, verbose_name="Created by", related_name="owner")
...
class ODKProjectPermissions(TimeStampedModel):
    ...
    project = models.ForeignKey(ODKProjects, on_delete=models.CASCADE, verbose_name="Project")
    granted_by = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="Granted by")
...
class ODKUserSessions(TimeStampedModel):
    ...
    user = models.OneToOneField(User, on_delete=models.CASCADE, verbose_name="Sycosur User")
...
class ODKAuditLogs(TimeStampedModel):
    ...
    resource_type = models.CharField(verbose_name="Resource Type", max_length=30, choices=Resources.choices , default=None)
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="User", related_name="odk_logs")
